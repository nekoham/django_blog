...
urlpatterns = [
    path('list/', views.IndexData.as_view(), name='bloglistdata'),
    path('<int:pk>/', views.DetailData.as_view(), name='blogdetaildata'),
    path('<int:pk>/delete/', views.DeleteBlogData.as_view(), name='blogdeletedata'),
    path('create/', views.CreateBlogData.as_view(), name='blogcreatedata'),
    path('<int:pk>/update/', views.UpdateBlogData.as_view(), name='blogupdatedata'),
